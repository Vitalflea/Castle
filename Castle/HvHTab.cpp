...
{
	const char* yTypes[] = {
		"SLOW SPIN", "FAST SPIN", "SPIN_RANDOM", "JITTER", "CASUALJITTER", "RANDOMBACKJITTER", "BACKJITTER", "SIDE", "BACKWARDS", "FORWARDS", "LEFT", "RIGHT", "STATIC", "STATIC JITTER", "STATIC SMALL JITTER", "LOWERBODY", "LBYJITTER", "LBY ON GROUND", // safe
